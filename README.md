# oss-audit-24BCE10960


This is my Open Source Software lab repo for auditing **Git** on **Ubuntu 24.04 (WSL2)**.


I’m **Shiva Rohith** (`shiva rohith`, reg no `24BCE10960`). I wrote a few small shell scripts to pull basic system info, check package info, audit a couple of directories, and scan a log file for keyword matches.
...
- `manifesto_shiva rohith.txt` - Example output from the manifesto generator


## How to run the scripts


From the repo directory (`/home/shiva rohith/oss-audit-24BCE10960`):
